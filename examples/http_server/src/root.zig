...
fn callRequestHandler(self: *HttpServerObject, req: *httpz.Request, res: *httpz.Response) !void {
    ...
    // For now, just return a simple response to avoid string creation issues
    res.status = 200;
    res.body = "Hello from Zig HTTP Server!";
    
    // TODO: Implement full PHP callback once string issues are resolved
...
// Register the HttpServer class
const HttpServer = phpzx.PhpClass("HttpServer", HttpServerObject);

// Module startup - register the HttpServer class
